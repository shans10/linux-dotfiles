...
nmap <leader>dr :Denite file/rec<CR>
nmap <leader>db :Denite buffer<CR>
nmap <leader>dw :Denite grep<CR>                " Find word
nmap <leader>dc :DeniteCursorWord grep<CR>      " Find word under cursor
nmap <leader>dl :Denite line<CR>
